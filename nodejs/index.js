...
app.post("/api/confirm-booking", async (req, res) => {
  ...
  if (!formData || !formData.email) {
    ...
    return res
      .status(400)
      .send({ message: "Invalid booking details provided." });
  }
  ...
  <p>Please arrive 15 minutes early with your driver’s license and any other required documents. If you need to change your appointment, please contact us at [Contact Information].</p>
